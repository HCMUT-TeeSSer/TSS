        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-10">
            ...
            <section className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-5 w-5 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center text-xs">✓</span>
            ...
            <section className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-slate-500">
                  {modules.length} module • Cập nhật 11/2025
                </span>
              </div>
          ...
          <aside className="space-y-4">
            ...
            <section className="bg-white rounded-xl shadow-sm border border-slate-100 p-5 text-sm">
              <h3 className="font-semibold text-slate-900 mb-3">Chi tiết chương trình</h3>
            ...
            {/* Giảng viên */}
            <section className="bg-white rounded-xl shadow-sm border border-slate-100 p-5 text-sm">
              <h3 className="font-semibold text-slate-900 mb-3">Giảng viên</h3>

              <div className="flex items-center gap-3 mb-2">
                <div className="h-10 w-10 rounded-full bg-sky-100 flex items-center justify-center text-sky-700 font-semibold">Đ</div>
                <div>
            ...
            {/* Lớp tiếp theo */}
            <section className="bg-white rounded-xl shadow-sm border border-slate-100 p-5 text-sm">
              <h3 className="font-semibold text-slate-900 mb-3">Lớp tiếp theo</h3>
              ...
              <button className="w-full px-3 py-2 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700">
