              ...
              {isPythonProgram ? (
                <ul className='space-y-2 text-sm text-slate-700'>
                  ...
                  <li className='flex items-start gap-2'>
                    ...
                    <span>Hiểu pipeline cơ bản của Machine Learning và sử dụng scikit-learn cho mô hình đơn giản.</span>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='mt-1 flex h-5 w-5 items-center justify-center rounded-full bg-emerald-50 text-xs text-emerald-600'>
                      ✓
                ...
                <p className='text-sm text-slate-600'>
                  Mục tiêu cụ thể cho chương trình này đang được cập nhật. Bạn vẫn có thể đăng ký theo dõi chương trình
                  để nhận thông báo khi có thông tin mới.
                </p>
              )}
            </section>
